...
\[\begin{tikzcd}
	\Set \arrow[bend left=20,below]{rr}{F}
	& \ld &
	\arrow[bend left=20,above]{ll}{U} \Mod(\T,\Set).
\end{tikzcd}\]
...
\end{array}\]
such that for $x \in \Obj(\V)$ and $a,b \in \Obj(\C)$, there is the adjunction (provided the objects exist):
