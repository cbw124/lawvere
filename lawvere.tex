...
\item The free category functor $\FC \maps \sSet$, often called `realization', preserves products.
\end{itemize}
...
The ``free category'' functor $\FC\maps \RGph \to \Cat$ gives for every graph $G$ the category $\FC(G)$: %whose objects are the vertices of $G$, and whose morphisms are freely generated by the edges of $G$, i.e. sequences 
\[\begin{array}{rl}
