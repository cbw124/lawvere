...
n_\V \cong 1^{n_\V}
\end{equation}
in $\NN_\V^\op$.   While perhaps strange at first, this just the opposite of the usual isomorphism $n_\V \cong n_\V^1$ in $\NN_\V$.   Then, since $\tau$ preserves $\NN_\V$-powers and is bijective on objects, this implies that every object of $\T$ is an $\NN_\V$-power of $t = \tau(1_\V)$.
