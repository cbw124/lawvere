...
sends each finite set $n \in N$ to the representable functor $\T(\tau(n),-)\maps \T \to \Set$, and in general any set $X$ to the colimit of all such representable functors as $n$ ranges over all finite subsets of $X$.   In rough terms, this gives the set of all possible $n$-ary operations on the possibly infinite set $X$.
